...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative flex min-h-screen flex-col justify-start md:justify-evenly overflow-hidden px-5 pt-5 md:px-10 md:pt-10 lg:px-15 lg:pt-5">
      <InteractiveGrid 
        totalCells={50} 
      />
