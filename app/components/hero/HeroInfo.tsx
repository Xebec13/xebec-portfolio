...
export default function HeroInfo({ firstName, lastName, imgSrc }: HeroInfoProps) {
  return (
    <div className="relative flex flex-col-reverse justify-center gap-5 md:flex-row md:justify-between">
      <h1 className="relative z-10 max-w-fit text-[clamp(4.25rem,2rem+7.5vw,13rem)] font-semibold uppercase leading-none text-neutral-900 pointer-events-none tracking-tighter">
